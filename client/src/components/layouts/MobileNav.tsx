...
const MobileNav: React.FC<MobileNavProps> = ({ userRole, activePage }) => {
  ...
  return (
    <>
      <div className="md:hidden flex items-center justify-center p-4 bg-white border-b border-gray-200">
        <img src={logoSvg} alt="DDJ Flight Academy" className="h-8" />
      </div>
